...
/*#__PURE__*/
function (_Component) {
  (0, _inherits2.default)(IceFormBinderWrapper, _Component);
  (0, _createClass2.default)(IceFormBinderWrapper, [{
    key: "getChildContext",
  ...
  function IceFormBinderWrapper(props) {
    ...
    (0, _classCallCheck2.default)(this, IceFormBinderWrapper);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(IceFormBinderWrapper).call(this, props));
    ...
    _this.validate = function (name) {
      ...
      var validator = new _asyncValidator.default((0, _defineProperty2.default)({}, name, rules));
      validator.validate((0, _defineProperty2.default)({}, name, _this.getter(name)), function (errors) {
